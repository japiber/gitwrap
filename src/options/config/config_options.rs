...
/// --global
pub fn global() -> CommandOption<'static> {
    Box::new(|g: &mut CommandExecutor| g.add_option("--global"))
}

/// For writing options: write to system-wide $(prefix)/etc/gitconfig rather than the repository .git/config.
/// --system
pub fn system() -> CommandOption<'static> {
...
pub fn file(config_file_arg :&str) -> CommandOption {
...
/// --blob <blob>
pub fn blob(blob_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| {
        g.add_option("--blob");
...
/// --bool
pub fn bool() -> CommandOption<'static> {
...
/// --int
pub fn int() -> CommandOption<'static> {
...
/// --bool-or-int
pub fn bool_or_int() -> CommandOption<'static> {
...
/// --path
pub fn path() -> CommandOption<'static> {
...
/// --name-only
pub fn name_only() -> CommandOption<'static> {
...
/// --show-origin
pub fn show_origin() -> CommandOption<'static> {
