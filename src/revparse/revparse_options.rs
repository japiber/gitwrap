...
/// --parseopt
pub fn parseopt() -> CommandOption<'static> {
...
/// --keep-dashdash
pub fn keep_dashdash() -> CommandOption<'static> {
...
/// --stop-at-non-option
pub fn stop_at_non_option() -> CommandOption<'static> {
...
/// --stuck-long
pub fn stuck_long() -> CommandOption<'static> {
...
/// --prefix <arg>
pub fn prefix(arg_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| {
        g.add_option("--prefix");
        g.add_option(arg_arg);
    })
...
/// --sq
pub fn sq() -> CommandOption<'static> {
...
/// --short[=length]
pub fn short(value :&str) -> CommandOption {
    if value.is_empty() {
...
/// --not
pub fn not() -> CommandOption<'static> {
...
pub fn abbrev_ref(value :&str) -> CommandOption {
    if value.is_empty() {
...
/// --symbolic
pub fn symbolic() -> CommandOption<'static> {
...
/// --symbolic-full-name
pub fn symbolic_full_name() -> CommandOption<'static> {
...
pub fn branches(value :&str) -> CommandOption {
    if value.is_empty() {
...
/// If the pattern does not contain a globbing character (?, *, or [), it is turned into a prefix match by appending /*.
/// --branches[=pattern], --tags[=pattern], --remotes[=pattern]
pub fn tags(value :&str) -> CommandOption {
    if value.is_empty() {
...
/// If the pattern does not contain a globbing character (?, *, or [), it is turned into a prefix match by appending /*.
/// --branches[=pattern], --tags[=pattern], --remotes[=pattern]
pub fn remotes(value :&str) -> CommandOption {
    if value.is_empty() {
...
/// If the pattern does not contain a globbing character (?, *, or [), it is turned into a prefix match by appending /*.
/// --glob=pattern
pub fn glob(pattern_arg :&str) -> CommandOption {
...
pub fn exclude(glob_pattern_arg :&str) -> CommandOption {
...
/// --disambiguate=<prefix>
pub fn disambiguate(prefix_arg :&str) -> CommandOption {
...
pub fn resolve_git_dir(path_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| {
...
/// --git-path <path>
pub fn git_path(path_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| {
...
pub fn show_superproject_working_tree() -> CommandOption<'static> {
...
/// --shared-index-path
pub fn shared_index_path() -> CommandOption<'static> {
...
pub fn since(datestring_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| g.add_option_string(format!("--since={}", datestring_arg)))
}

/// Parse the date string, and output the corresponding --max-age= parameter for git rev-list.
/// --since=datestring, --after=datestring
pub fn after(datestring_arg :&str) -> CommandOption {
...
pub fn until(datestring_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| g.add_option_string(format!("--until={}", datestring_arg)))
}

/// Parse the date string, and output the corresponding --min-age= parameter for git rev-list.
/// --until=datestring, --before=datestring
pub fn before(datestring_arg :&str) -> CommandOption {
