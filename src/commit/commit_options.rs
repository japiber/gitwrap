...
pub fn reuse_message_option(commit_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| g.add_option_string(format!("--reuse-message={}", commit_arg)))
}

/// Like -C, but with -c the editor is invoked, so that the user can further edit the commit message.
/// -c <commit>, --reedit-message=<commit>
pub fn reedit_message_option(commit_arg :&str) -> CommandOption {
...
/// --fixup=<commit>
pub fn fixup_option(commit_arg :&str) -> CommandOption {
...
/// See git-rebase(1) for details.
/// --squash=<commit>
pub fn squash_option(commit_arg :&str) -> CommandOption {
...
/// --reset-author
pub fn reset_author_option() -> CommandOption<'static> {
...
/// --author=<author>
pub fn author_option(author_arg :&str) -> CommandOption {
    Box::new(move |g: &mut CommandExecutor| g.add_option_string(format!("--author={}", author_arg)))
}

/// Override the author date used in the commit.
/// --date=<date>
pub fn date_option(date_arg :&str) -> CommandOption {
...
pub fn template_option(file_arg :&str) -> CommandOption {
...
/// --amend
pub fn amend_option() -> CommandOption<'static> {
    Box::new(|g: &mut CommandExecutor| g.add_option("--amend"))
}

/// Bypass the post-rewrite hook.
/// --no-post-rewrite
pub fn no_post_rewrite_option() -> CommandOption<'static> {
...
/// -i, --include
pub fn include_option() -> CommandOption<'static> {
...
/// -o, --only
pub fn only_option() -> CommandOption<'static> {
...
/// --status
pub fn status_option() -> CommandOption<'static> {
...
/// --no-status
pub fn no_status_option() -> CommandOption<'static> {
