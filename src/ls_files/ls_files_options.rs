...
/// -i, --ignored
pub fn ignored() -> CommandOption<'static> {
    Box::new(|g: &mut CommandExecutor| g.add_option("--ignored"))
}

/// Show staged contents' mode bits, object name and stage number in the output.
/// -s, --stage
pub fn stage() -> CommandOption<'static> {
...
/// -k, --killed
pub fn killed() -> CommandOption<'static> {
...
/// --deduplicate
pub fn deduplicate() -> CommandOption<'static> {
...
/// --with-tree=<tree-ish>
pub fn with_tree(tree_ish_arg :&str) -> CommandOption {
...
/// --recurse-submodules
pub fn recurse_submodules() -> CommandOption<'static> {
...
/// --debug
pub fn debug() -> CommandOption<'static> {
...
/// --eol
pub fn eol() -> CommandOption<'static> {
...
/// --sparse
pub fn sparse() -> CommandOption<'static> {
